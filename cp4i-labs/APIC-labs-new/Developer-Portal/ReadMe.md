...
The portal is setup for self service so we will create a new account as a developer. If you have already created an account in another lab, you can skip to Step 16.  If not, click on **Create an account**.
