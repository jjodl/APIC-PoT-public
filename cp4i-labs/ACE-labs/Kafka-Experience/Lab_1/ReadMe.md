...
**Note:** The "Add property +" is used to add additonal property fields. 
...
11\. Now fiil in the fields.  We will use the SCRAM credentials we saved earlier.  
